                                    ...
                                    <tr>                        <!--<br />-->
                                        <td>class:</td><td>
                                            <select name="class">
                                                ...
                                                <option value="1" ${class == '1' ? 'selected' : ''}>recommend</option>
                                                <option value="2" ${class == '2' ? 'selected' : ''}>very_recom</option>
                                                <option value="3" ${class == '3' ? 'selected' : ''}>priority</option>
                                                <option value="4" ${class == '4' ? 'selected' : ''}>spec_prior</option>
                                            </select></td>
                                    </tr>
                                    <!--<br />-->
                                    <tr>                        <!--<br />-->
